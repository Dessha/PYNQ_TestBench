...
#ifndef _CLoop_XADC_Mctrl_Bram_xlslice_0_0_core_h_
#define _CLoop_XADC_Mctrl_Bram_xlslice_0_0_core_h_

#include <systemc.h>
#include "properties.h"


class CLoop_XADC_Mctrl_Bram_xlslice_0_0_core : public sc_module 
{
    public: 
       CLoop_XADC_Mctrl_Bram_xlslice_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(CLoop_XADC_Mctrl_Bram_xlslice_0_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~CLoop_XADC_Mctrl_Bram_xlslice_0_0_core() = default;
